...
// `rstack.rstest.copyTestItemErrors` command can surface them. Kept separate from
// RstestDiagnostics because that store is gated on `rstack.rstest.applyDiagnostic` and
