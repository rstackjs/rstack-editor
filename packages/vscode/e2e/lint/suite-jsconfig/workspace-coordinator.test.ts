...
// `packages/vscode-extension/__tests__/suite-jsconfig/workspace-coordinator.test.ts`
// (origin/main). Only the import path changed: the copied extension sources
// live under `src/stacks/lint/` in this repo.
