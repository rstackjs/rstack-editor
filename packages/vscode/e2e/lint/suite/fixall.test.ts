...
suite('rslint fixAll - code actions', function () {
  ...
  test('works after rapid edit without debounce', async () => {
    // Upstream re-imported `replaceAll` dynamically here; the static import at
    // the top of this file is the same binding (nodenext forbids the
    // extensionless dynamic form).
